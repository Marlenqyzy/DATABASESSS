create table costumers (
	...
	delivery address VARCHAR(50),
	primary key(Id),

);
insert into costumers (Id, full_name, timestamp, delivery address) values (1, 'Coleen Crichten', '11:42 PM', '9 Kim Point');
insert into costumers (Id, full_name, timestamp, delivery address) values (2, 'Mair MattiCCI', '6:05 PM', '5 Straubel Parkway');
insert into costumers (Id, full_name, timestamp, delivery address) values (3, 'Wilmar Mabey', '3:35 PM', '70417 Arkansas Drive');
insert into costumers (Id, full_name, timestamp, delivery address) values (4, 'Royal Muckart', '1:19 PM', '48992 Parkside Street');
insert into costumers (Id, full_name, timestamp, delivery address) values (5, 'Myrilla Caplan', '6:22 AM', '1582 Dunning Plaza');
...
insert into order_items (order_code, product_id, quantity) values (1, 1, 1);
insert into order_items (order_code, product_id, quantity) values (2, 2, 2);
insert into order_items (order_code, product_id, quantity) values (3, 3, 3);
insert into order_items (order_code, product_id, quantity) values (4, 4, 4);
insert into order_items (order_code, product_id, quantity) values (5, 5, 5);
